...
function MatchComponent() {
    ...
    useEffect(() => {
      ...
      const mentorMatch = `I have 4 JSON structured objects. Compare object with id = "ment1" to the 3 other objects [id = "p1", id = "p2", id = "p3"]. Specifically, compare the field expertise and interest of id = "ment1" between the job, expertise, and interest fields of the other 3 objects. Rank the similarity 1-10 of ment1 between p1, p2, and p3. Your response should be "Congratulations! Your similarity score is (add similarity score) with (add fname and lname of ment1): ${menteeXmentorString}`;
  ...
  return (
    <>
    <Button onClick={onButtonClick} variant="contained">Your Mentee Match</Button>
        <p>{message}</p>
